# HydroMind水网仿真结果报告: Simple Sediment Transport Example

**生成时间**: 2026-03-21 09:12:18

## 1. 问题描述

本报告关注 `Simple Sediment Transport Example` 的水网/河网仿真结果与 HydroMind 对比验证。案例类别为 `1D Sediment Transport`。重点是水面线、过程线、峰值响应、HydroMind 对比精度和后续改进建议。
...
| 流量单位 | m3/s |
| 详细指标 | |
| 案例名称 | Simple Sediment Transport Example |
