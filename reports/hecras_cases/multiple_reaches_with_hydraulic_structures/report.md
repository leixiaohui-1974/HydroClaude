# HydroMind水网仿真结果报告: Multiple Reaches with Hydraulic Structures

**生成时间**: 2026-03-21 13:21:16
...
| 指标 | 数值 |
|---|---|
| 案例名称 | Multiple Reaches with Hydraulic Structures |
| 类别 | 1D Unsteady Flow Hydraulics |
| 运行状态 | computed |
| 当前 Plan | p01 |
| 结果来源 | hecras_example_suite_chunk_20_29.json |
| 结果 HDF | 3ReachUnsteady.p01.hdf |
| Plan 数 | 2 |
| 几何文件数 | 2 |
| 边界/流量文件数 | 2 |
| 断面数 | 20 |
...
- 对标建议: 属于稳态明渠但边界或断面条件较复杂，可做部分口径对照，不适合作为首批公平样例。
