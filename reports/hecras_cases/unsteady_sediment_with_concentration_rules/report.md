# HydroMind水网仿真结果报告: Unsteady Sediment with Concentration Rules

**生成时间**: 2026-03-21 13:19:47
...
| 指标 | 数值 |
|---|---|
| 案例名称 | Unsteady Sediment with Concentration Rules |
| 类别 | 1D Sediment Transport |
| 运行状态 | computed |
| 当前 Plan | p05 |
| 结果来源 | hecras_example_suite_chunk_00_09.json |
| 结果 HDF | SedRuleLat.p05.hdf |
| Plan 数 | 1 |
| 几何文件数 | 1 |
| 边界/流量文件数 | 1 |
| 断面数 | 57 |
