# HydroMind水网仿真结果报告: Example 18 - Advanced Inline Structure

**生成时间**: 2026-03-21 13:21:28
...
| 指标 | 数值 |
|---|---|
| 案例名称 | Example 18 - Advanced Inline Structure |
| 类别 | Applications Guide |
| 运行状态 | computed |
| 当前 Plan | p01 |
| 结果来源 | hecras_example_suite_chunk_50_59.json |
| 结果 HDF | InlineStructureE.p01.hdf |
| Plan 数 | 1 |
| 几何文件数 | 1 |
| 边界/流量文件数 | 1 |
| 断面数 | 57 |
