# HydroMind水网仿真结果报告: Example 19 - Hydrologic Routing - ModPuls

**生成时间**: 2026-03-21 13:21:32
...
| 指标 | 数值 |
|---|---|
| 案例名称 | Example 19 - Hydrologic Routing - ModPuls |
| 类别 | Applications Guide |
| 运行状态 | computed |
| 当前 Plan | p03 |
| 结果来源 | hecras_example_suite_chunk_50_59.json |
| 结果 HDF | ModPulsRoutingTes.p03.hdf |
| Plan 数 | 3 |
| 几何文件数 | 5 |
| 边界/流量文件数 | 4 |
| 断面数 | 179 |
