# HydroMind水网仿真结果报告: Example 15 - Split Flow Junction with Lateral Weir

**生成时间**: 2026-03-20 22:30:30
...
| 指标 | 数值 |
|---|---|
| 案例名称 | Example 15 - Split Flow Junction with Lateral Weir |
| 类别 | Applications Guide |
| 运行状态 | computed |
| 当前 Plan | p01 |
| 结果来源 | hecras_example_suite_chunk_40_49.json |
| 结果 HDF | SPLIT_LW.p01.hdf |
| Plan 数 | 1 |
| 几何文件数 | 1 |
| 边界/流量文件数 | 1 |
| 断面数 | 23 |
...
- 结果曲线已按 4 个 river/reach 河段分组重排，避免多河段案例因断面编号交错而出现假性锯齿。
