# HydroMind水网仿真结果报告: Lateral Structure connected to a River Reach

**生成时间**: 2026-03-21 13:20:56
...
| 指标 | 数值 |
|---|---|
| 案例名称 | Lateral Structure connected to a River Reach |
| 类别 | 1D Unsteady Flow Hydraulics |
| 运行状态 | computed |
| 当前 Plan | p01 |
| 结果来源 | hecras_example_suite_chunk_20_29.json |
| 结果 HDF | 3Reach_with_Lat.p01.hdf |
| Plan 数 | 1 |
| 几何文件数 | 1 |
| 边界/流量文件数 | 1 |
| 断面数 | 20 |
