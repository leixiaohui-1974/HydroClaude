# HydroMind水网仿真结果报告: Unsteady Flow Encroachment Analysis

**生成时间**: 2026-03-21 09:11:37

## 1. 问题描述

本报告关注 `Unsteady Flow Encroachment Analysis` 的水网/河网仿真结果与 HydroMind 对比验证。案例类别为 `1D Unsteady Flow Hydraulics`。重点是水面线、过程线、峰值响应、HydroMind 对比精度和后续改进建议。
...
| 当前 Plan | p01 |
| 单位体系 | 国际单位制 (SI) |
| 聚合来源 | hecras_example_suite_chunk_30_39.json |
...
| 流量单位 | m3/s |
| 详细指标 | |
| 案例名称 | Unsteady Flow Encroachment Analysis |
| 类别 | 1D Unsteady Flow Hydraulics |
| 运行状态 | computed |
| 当前 Plan | p01 |
| 结果来源 | hecras_example_suite_chunk_30_39.json |
| 结果 HDF | UnsteadyEncroachment.p01.hdf |
