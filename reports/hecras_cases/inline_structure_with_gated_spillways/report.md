# HydroMind水网仿真结果报告: Inline Structure with Gated Spillways

**生成时间**: 2026-03-21 13:20:36
...
| 当前 Plan | p01 |
| 单位体系 | 国际单位制 (SI) |
| 聚合来源 | hecras_example_suite_chunk_10_19.json |
...
| 指标 | 数值 |
|---|---|
| 案例名称 | Inline Structure with Gated Spillways |
| 类别 | 1D Unsteady Flow Hydraulics |
| 运行状态 | computed |
| 当前 Plan | p01 |
| 结果来源 | hecras_example_suite_chunk_10_19.json |
| 结果 HDF | Inline_3Gates.p01.hdf |
| Plan 数 | 1 |
| 几何文件数 | 1 |
| 边界/流量文件数 | 1 |
| 断面数 | 35 |
