...
print("   - 参数来源: 经验值未从实际系统辨识")
print("   - 结论: 模型参数不准确")

print("\n修复方案")
print(" 方案1修改IDZ模型方向推荐")
...
print("\n" + "=" * 80)
print("开始验证方案1反转IDZ模型方向")
print("=" * 80)

# 测试反转符号的效果
print("\n测试如果MPC使用K=-100负值")
print("场景h=2.5m, 目标=2.2m, 误差=0.3m (水位过高)")
print()
...
print("\n" + "=" * 80)
print("结论MPC性能差的根本原因是模型方向与实际系统相反")
print("=" * 80)
