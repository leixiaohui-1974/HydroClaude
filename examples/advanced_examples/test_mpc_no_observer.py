...
controller = MPCController(idz_params, mpc_config, use_observer=False)
...
print(f"\n  状态估计 x_hat = {controller.x_hat}")
print(f"  预测输出 y = C @ x_hat = {controller.C @ controller.x_hat:.4f}m")
print(f"  MPC输出：u_optimal = {u_optimal:.4f}m")
