...
def run_sluice_gate_dynamics():
    ...
    print("=" * 80)
    print("示例1扩展：明渠闸门过流动力学分析（重构版 v2.0）")
    print("=" * 80)
    print()
    ...
    Q_steady = solver.hu * canal_width
    ...
    fig1 = plotter.plot_profile(
        ...
        title="Steady State - Water Depth Profile (HydrostaticCanalSolver)",
