...
def run_example():
    ...
    table_path = helper.get_output_path('archive_01_simple_time_series_refactored.csv', subdir='tables')

    time_series_df.to_csv(table_path, index=False)
    ...
    table_path = helper.get_output_path('archive_01_simple_spatial_profile_refactored.csv', subdir='tables')
