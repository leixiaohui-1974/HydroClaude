...
# -*- coding: utf-8 -*-
"""
例子1：明渠非恒定流 - 重构版（ScriptHelper现代化）

使用新的基础库框架和ScriptHelper，代码更简洁、可维护
...
def main():
    """主函数"""
    print("=" * 80)
    print("例子1：明渠非恒定流仿真 - 重构版（ScriptHelper现代化）")
    print("=" * 80)
    ...
    # 单个方法的时空分布
    for method in methods:
        save_path = helper.get_output_path(f'01_basic_{method.lower()}_refactored.png', subdir='figures')
    ...
    print("仿真完成！")
    print("=" * 80)
    print(f"\n所有输出已保存到: {helper.output_dir}/")
    print(f"  Figures: {helper.output_dir / 'figures'}/")
    print(f"  Tables: {helper.output_dir / 'tables'}/")
    print("\n✅ 例子1（ScriptHelper重构版）运行成功")
