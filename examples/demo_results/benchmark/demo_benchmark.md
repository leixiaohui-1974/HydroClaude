...
|------|-------|------|---------|---------|------------|----------|
| Single Gate | Newton |  | 5 | 0.0088 | 0.0000 | 4.08e-02 |
| Single Gate | Continuation |  | 7 | 0.0140 | 0.0000 | 1.82e-03 |
...
|-------|------------|------------|----------------|
| Continuation | 7.0 | 0.0140 | 0.0000 |
| Newton | 5.0 | 0.0088 | 0.0000 |
...
1. **Newton** 是平均速度最快的求解器 (平均时间: 0.0088s)
...
*报告由 HydroClaude BenchmarkReporter 自动生成于 2025-11-14 00:52:23*
