...
|------|-------|------|---------|---------|------------|----------|
| Single Gate | Newton |  | 5 | 0.0086 | 0.0000 | 4.08e-02 |
...
1. **Newton** 是平均速度最快的求解器 (平均时间: 0.0086s)
...
*报告由 HydroClaude BenchmarkReporter 自动生成于 2025-11-15 07:07:52*
