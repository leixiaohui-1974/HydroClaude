...
|------|-------|------|---------|---------|------------|----------|
| Single Gate | Newton |  | 5 | 0.0087 | 0.0000 | 4.08e-02 |
| Single Gate | Continuation |  | 7 | 0.0137 | 0.0000 | 1.82e-03 |
...
|-------|------------|------------|----------------|
| Newton | 5.0 | 0.0087 | 0.0000 |
| Continuation | 7.0 | 0.0137 | 0.0000 |
...
| 场景 | 目标求解器 | 加速比 (x) |
|------|-----------|----------|
| Single Gate | Continuation | 0.63x |
...
1. **Newton** 是平均速度最快的求解器 (平均时间: 0.0087s)
...
*报告由 HydroClaude BenchmarkReporter 自动生成于 2025-11-15 07:04:31*
