...
|------|-------|------|---------|---------|------------|----------|
| Single Gate | Newton |  | 5 | 0.0422 | 0.0000 | 4.08e-02 |
| Single Gate | Continuation |  | 7 | 0.0623 | 0.0000 | 1.82e-03 |
...
|-------|------------|------------|----------------|
| Newton | 5.0 | 0.0422 | 0.0000 |
| Continuation | 7.0 | 0.0623 | 0.0000 |
...
| 场景 | 目标求解器 | 加速比 (x) |
|------|-----------|----------|
| Single Gate | Continuation | 0.68x |
...
1. **Newton** 是平均速度最快的求解器 (平均时间: 0.0422s)
2. **Newton** 迭代次数最少 (平均: 5.0次)
3. **Newton** 成功率最高 (100.0%)
...
*报告由 HydroClaude BenchmarkReporter 自动生成于 2025-11-13 15:50:13*
