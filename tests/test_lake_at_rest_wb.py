...
class LakeAtRestTest:
    ...
    def _plot_results(self):
        ...
        for idx, test_id in enumerate(test_ids):
            ...
            ax1.set_title(f'{test_id}: {result["name"]}')
            ax1.legend()
            ...
            ax2.set_title(f'Water Depth (disturbance={result["eta_disturbance"]:.2e}m)')
