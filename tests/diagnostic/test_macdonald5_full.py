...
def test_macdonald5_full():
    """
    MacDonald Test 5: 宽浅河道正常水深完整测试
    """
    print("\n" + "="*80)
    ...
    print(f"\n运行模拟...")
    print(f"  结束时间: {config['simulation']['end_time']:.0f} s")
